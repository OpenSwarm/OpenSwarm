...
\begin{DoxyCompactList}\small\item\em Linked list element of messages that need to be sent via I2\+C. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
...
\begin{DoxyCompactList}\small\item\em Linked list element of messages that need to be sent via I2\+C. \end{DoxyCompactList}\item 
