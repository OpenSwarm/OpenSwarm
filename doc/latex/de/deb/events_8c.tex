...
\begin{DoxyCompactList}\small\item\em A struct to store a list of subscribed processes. \end{DoxyCompactList}\item 
struct \hyperlink{structsys__registered__event__s}{sys\+\_\+registered\+\_\+event\+\_\+s}
\begin{DoxyCompactList}\small\item\em A struct to store registered events. It also includes a list of processes that are subscribed to the registered event. \end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Typedefs}
\begin{DoxyCompactItemize}
\item 
...
\hypertarget{events_8c_a855a9b5c8c07fedd9f2a8bbf5ee9b4f0}{}\index{events.\+c@{events.\+c}!sys\+\_\+subscribed\+\_\+process@{sys\+\_\+subscribed\+\_\+process}}
