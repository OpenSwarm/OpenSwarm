...
\begin{DoxyCompactList}\small\item\em declares the system clock that provides a continuous time value (granulation of 1 ms). \end{DoxyCompactList}\end{DoxyCompactItemize}
